...
class HomeView(View):
    ...
    def get(self, request):        
        ...
        def profitperday(perdaypurchase,perdaysale):
            if(perdaysale==None and perdaypurchase ==None):
                return ''
            elif (perdaypurchase == perdaysale):
        ...
        def profit(totalpurchase,totalsale):
            if(totalpurchase==None) or (totalsale==None):
                totalpurchase=0
                totalsale=0
            if totalpurchase>totalsale:
               return 'Loss'
            elif totalpurchase<totalsale:
                return 'Profit'
        ...
        suppliers=Supplier.objects.filter().count()
        print(suppliers)
