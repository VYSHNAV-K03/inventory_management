...
class SupplierForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['house'].widget.attrs.update({'class': 'textinput form-control'})
        self.fields['city'].widget.attrs.update({'class': 'textinput form-control'})
        self.fields['street'].widget.attrs.update({'class': 'textinput form-control'})
        self.fields['state'].widget.attrs.update({'class': 'textinput form-control'})
       
    class Meta:
        model = Supplier
        fields = ['name', 'phone', 'email','house','street','city','state']
        widgets = {
